...
def _install_agent_compat():
    ...
    sys.modules.setdefault("src.agents.base", _module(
        "src.agents.base",
        {"InvestAgent": InvestAgent, "AgentConfig": AgentConfig, "Belief": Belief},
    ))
    sys.modules.setdefault("src.agents.market_regime", _module(
        "src.agents.market_regime",
        {"MarketRegimeAgent": MarketRegimeAgent, "REGIME_PARAMS": REGIME_PARAMS},
    ))
    sys.modules.setdefault("src.agents.trend_hunter", _module(
        "src.agents.trend_hunter",
        {"TrendHunterAgent": TrendHunterAgent},
    ))
    sys.modules.setdefault("src.agents.contrarian", _module(
        "src.agents.contrarian",
        {"ContrarianAgent": ContrarianAgent},
    ))
    sys.modules.setdefault("src.agents.strategist", _module(
        "src.agents.strategist",
        {"StrategistAgent": StrategistAgent},
    ))
    sys.modules.setdefault("src.agents.commander", _module(
        "src.agents.commander",
        {"CommanderAgent": CommanderAgent},
    ))
    sys.modules.setdefault("src.agents.evo_judge", _module(
        "src.agents.evo_judge",
        {"EvoJudgeAgent": EvoJudgeAgent},
    ))


_install_agent_compat()
