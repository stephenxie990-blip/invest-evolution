...
- 设计文档：`docs/MAIN_FLOW.md`、`docs/TRAINING_FLOW.md`、`docs/DATA_ACCESS_ARCHITECTURE.md`、`docs/blueprints/RESEARCH_ENGINE_UNIFICATION_EXECUTION_BLUEPRINT_20260312.md`
