...
def _default_specs() -> List[ManagerSpec]:
    return [
        ...
        ManagerSpec(
            ...
            mandate="Exploit oversold snap-back opportunities in choppy markets.",
            style_profile={"bull": 0.35, "oscillation": 1.0, "bear": 0.25},
        ...
        ManagerSpec(
            ...
            style_profile={"bull": 0.55, "oscillation": 0.75, "bear": 0.85},
        ...
        ManagerSpec(
            ...
            mandate="Protect capital in weak or high-volatility environments.",
            style_profile={"bull": 0.25, "oscillation": 0.65, "bear": 1.0},
