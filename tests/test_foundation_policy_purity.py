from invest_evolution.investment.foundation.compute import calc_algo_score, compute_market_stats
from invest_evolution.investment.foundation.compute import (
    compute_market_stats as compute_market_snapshot_stats,
)
...
def test_manager_runtime_config_exposes_explicit_market_and_summary_logic(tmp_path):
    ...
    summary_scoring = controller.manager_runtime.config_section('summary_scoring', {})
    market_regime = controller.manager_runtime.config_section('market_regime', {})
