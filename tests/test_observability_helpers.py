...
from app.commander_support.observability import memory_brief_row, read_event_rows
from app.runtime_artifact_reader import safe_read_jsonl


def _make_runtime(tmp_path: Path) -> SimpleNamespace:
    runtime_dir = tmp_path / "runtime"
    training_dir = runtime_dir / "training"
    meeting_dir = runtime_dir / "meetings"
