...
def _seed_case(runtime):
    snapshot = ResearchSnapshot(
        ...
        market_context={'regime': 'bull', 'cash_reserve': 0.2, 'manager_id': 'momentum', 'manager_config_ref': 'default', 'market_stats': {}, 'governance_context': {}},
        ...
        data_lineage={},
        readiness={'has_manager_output': True},
        metadata={'query_code': 'sh.600001'},
    )
    policy = PolicySnapshot(
        policy_id='policy_demo',
        manager_id='momentum',
        manager_config_ref='default',
