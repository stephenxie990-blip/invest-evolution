...
from market_data.manager import DataManager, DataSourceUnavailableError
...
def test_runtime_data_policy_disables_online_fallback(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr('market_data.manager.EvolutionDataLoader', _ForbiddenOnlineLoader)
